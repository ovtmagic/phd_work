...
def loo(midifiles,csv,train_filename,thres=0.25):
...
# Experimento 2--------------------------------------------------
def exp_3(midifiles,dirpath,train_filename,type_file):
    ...
    for path in dirpath:
        ...
        errores=[0,0,0,0]
        count=0
        x=loo(midifiles[path],csv,train_filename[path],umbral)  # { file_name:track, file_name:track, ....}
...
#type_file='bass'
#train_filename={"kar200":"/home/octavio/MIR/sc/des/arff/bass_jazzclas.arff",
#                "jazz200":"/home/octavio/MIR/sc/des/arff/bass_karclas200.arff",
#                "clas200":"/home/octavio/MIR/sc/des/arff/bass_karjazz200.arff"
#                }
#print "CLASS:",type_file
#print exp_3(midifiles,dirpath,train_filename,type_file)
#print
#print

type_file='melody'
train_filename={"kar200":"/home/octavio/MIR/sc/des/arff/melody_jazzclas.arff",
                "jazz200":"/home/octavio/MIR/sc/des/arff/melody_karclas200.arff",
                "clas200":"/home/octavio/MIR/sc/des/arff/melody_karjazz200.arff"
                }
print "CLASS:",type_file
print exp_3(midifiles,dirpath,train_filename,type_file)
print
