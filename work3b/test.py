...
__max_files__ = 20  # numero de ficheros midi que se van a utilizar en el test
__train_extension__ = ".model"

path_to_arff = "/home/octavio/Dropbox/MIR/Datasets/arff/"
path_to_testfiles = "/tmp/mir/txt/"
...
for corpus in exp2.keys():
    ...
    for midi_file in os.listdir(path_to_testfiles + corpus)[:__max_files__]:
        ...
        if not re.search(".sky",midi_file):
            corpus_midifiles[midi_file] = lmidi.Tsmf2txt(path_to_testfiles + corpus + "/" + midi_file, True, format='txt')
